...
def install_vicuna():
  ...
  # Download LLaMA weights and apply delta to obtain Vicuna-13B weights
    ...
    base_model_path = input("Enter the path to LLaMA-13B weights: ")
    target_model_path = input("Enter the output path for Vicuna-13B weights: ")
    ...
    print("Vicuna-13B model is ready.")
...
def main():
    ...
    if total_memory >= 60 * 1024:
        print("Your system has sufficient RAM to load the Vicuna-13B model.")
        install_vicuna()
    else:
        print("Your system does not have enough RAM to load the Vicuna-13B model.")
        print("Consider using the Vicuna-7B model, which requires around 30GB of CPU memory.")
